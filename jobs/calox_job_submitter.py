...
source_cmd = "source /home/yofeng/root/bin/thisroot.sh"
run_cmd_prep = "mkdir -p JOBTMP; export PCM_CACHE_DIR=JOBTMP; export TMPDIR=JOBTMP; cd SCRIPTDIR"
run_cmd_exec = " && python3 scripts/check_service_drs.py --run RUNNUMBER --jsroot && python3 scripts/check_drs_mcp.py --run RUNNUMBER"
...
def generate_submission_script(runlist):
    ...
    for i, run_number in enumerate(runlist):
        ...
        run_cmd_tmp = source_cmd + " && " + run_cmd_tmp
